/**
 * JS Table Filter 1.0 (jQuery 1.7+)
 * (c) 2012-2012 Fagner Martins Brack <fagnerbrack.com>
 * MIT license
 * 
 * JS Table Filter
 * Given a table with thead and tbody, JS Table Filter creates an input below all TDs of theads that automatically filters the content based on the innerHTML of each TD of the tbody
...
(function($) {
	$.fn.JSTableFilter = function(args) {
		var options = $.extend({
			...
			ignoreCase: true, //Verifies if JS Table Filter should ignore the case
